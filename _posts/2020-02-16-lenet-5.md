...
<img src="https://cdn.discordapp.com/attachments/676833120053493770/679441869272383548/02SVJziM1LQwmK-qe.png" hspace="20%" width="60%">
...
<img src="https://media.discordapp.net/attachments/676833120053493770/678198488122523658/legend.png?width=1223&height=688" hspace="15%" width="70%">
...
In the paper, there is several versions of LeNet (LeNet-1, LeNet-4, LeNet-5, Boosted LeNet-4
but here, we are going to focus only on LeNet-5.
...
We will use a simpler version of the LeNet-5 than the one described in the paper.\
For example, computation on average pooling layers described in the paper are slightly more complex than usual.
